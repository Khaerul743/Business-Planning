...
class ConversationRepository(IConversationRepository):
    ...
    async def get_conversation_by_id(
        ...
        try:
            ...
            self._logger.error(f"Error while get conversation by id: {str(e)}")
            raise e
    ...
    async def insert_new_conversation(
        ...
        try:
            ...
            self._logger.error(f"Error while insert new conversation: {str(e)}")
            raise e
    ...
    async def get_or_create_conversation(
        ...
        try:
            ...
            self._logger.error(f"Error while get or create conversation: {str(e)}")
            raise e
    ...
    async def get_all_conversations_by_business_id(
        ...
        try:
            ...
            self._logger.error(
                f"Error while get all conversation by business id: {str(e)}"
            )
            raise e
    ...
    async def get_paginated_conversations_by_business_id(
        ...
        try:
            ...
            self._logger.error(
                f"Error while get paginated conversation by business id: {str(e)}"
            )
            raise e
    ...
    async def update_conversation_status(
        ...
        try:
            ...
            self._logger.error(f"Error while update conversation status: {str(e)}")
            raise e
